 ...
 * MultiPartFormOutputStream.java was found
on the Sun Microsystems Java forum here:
...
public class MultiPartFormOutputStream {
	...
	public void writeFile(String name, String mimeType, File file) 
			throws java.io.IOException {
            //System.out.println("write file : "  + name + " file" + file.toString());
		if(file == null) {
	...
	public void writeFile(String name, String mimeType, 
			...
			throws java.io.IOException {
            //System.out.println("write file : "  + name + " file" + fileName);
		if(is == null) {
